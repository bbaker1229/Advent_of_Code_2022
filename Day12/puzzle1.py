...
starting_location = np.where(game_board == 'S')  # Find the location of the start
starting_location = (starting_location[0][0], starting_location[1][0])  # Set the start location using only integers
starting_state = ['S', starting_location]  # Set the start state
...
#Output data
print(f"The fewest number of steps is: {solution.depth}.")
